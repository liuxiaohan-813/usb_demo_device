...
/* ReportDescriptor mouse */
const unsigned char ReportDescriptor0[]=
{
...
/* ReportDescriptor keyboard */
const unsigned char ReportDescriptor1[]=
{
...
/* dev Configurations */
const unsigned char ConDes[9 + 9 + 9 + 7 + 9 + 9 + 7]=
{
    ...
    (sizeof(ReportDescriptor0) >> 8) & 0xFF, // wDescriptorLength
    // Endpoint
    0x07, // bLength
    ...
    (sizeof(ReportDescriptor1) >> 8) & 0xFF, // wDescriptorLength
          // Endpoint
    0x07, // bLength
    0x05, // bDescriptorType
    0x82, // Ep2 : In
...
const unsigned char Prod_Des[]=
{
    48,
    0x03,
    0x4e, 0x00, // Nuclei keyboard & mouse
    0x75, 0x00,
    0x63, 0x00,
    0x6c, 0x00,
    0x65, 0x00,
